...

{
  ...
  "description": "Official easyfeedback trackingcode for integration of surveys on website automatically. Easily add this tag to your workspace for using the function within easyfeedback to display feedback elements on all or separate pages on your website.",
  "categories": ["SURVEY"],
  "containerContexts": [
    "WEB"
  ]
